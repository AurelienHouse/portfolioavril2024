      ...
      <div className="flex max-md:flex-col gap-4">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground leading-loose">
            ...
            <Code>NextJs</Code> pour le back-end. Et bien sûr je n'hesite pas à
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground leading-loose">
            Je m'amuse beaucoup avec le Css en vanilla mais utilise souvent{" "}
            <Code>Tailwindcss</Code> pour les projets plus sérieux.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <OpenAiIcon size={42} />
          ...
          <p className="text-sm text-muted-foreground leading-loose">
            ...
            <Code>GitHubCopilot</Code> pour m'aider et accelerer mon code.
          </p>
        </div>
      </div>
    </Section>
